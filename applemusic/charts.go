...
type Chart struct {
	...
	Data []Resource //(Required) An array of the requested objects, ordered by popularity. For example, if songs were specified as the chart type in the request, the array contains Song objects.
